...
class AutoDisposableMaybeObserver<T> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
    @NonNull
    private final MaybeObserver<T> sourceObserver;

    AutoDisposableMaybeObserver(@NonNull MaybeObserver<T> observer, @NonNull CompositeDisposable disposable) {
