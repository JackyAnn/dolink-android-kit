...
public class ViewBindings {
  ...
  private static <VB extends ViewBinding> VB invoke(
      @NonNull Class<VB> viewbindingClass,
      @NonNull Class<?>[] parameterTypes,
      Object obj,
      @NonNull Object[] args) {
    Invocation invocation =
        Reflects.findInvocation(viewbindingClass, parameterTypes, viewbindingClass);
    try {
      @SuppressWarnings("unchecked")
      VB viewBinding = (VB) invocation.invoke(obj, args);
      return viewBinding;
    } catch (Throwable e) {
      throw new RuntimeException(
          String.format("Can not invoke %s for %s", invocation, viewbindingClass), e.getCause());
    }
  }

  public static <VB extends ViewBinding> VB inflate(
      @NonNull Class<VB> viewbindingClass, @NonNull LayoutInflater inflater) {
    return invoke(
        viewbindingClass, new Class<?>[] {LayoutInflater.class}, null, new Object[] {inflater});
  }
  ...
  public static <VB extends ViewBinding> VB inflate(
    ...
    return invoke(
        ...
        null,
        new Object[] {inflater, parent, attachToParent});
  }

  public static <VB extends ViewBinding> VB bind(
      @NonNull Class<VB> viewbindingClass, @NonNull View rootView) {
