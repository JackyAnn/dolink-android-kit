...
public class MainActivity extends AppCompatActivity implements View<LifecycleEvent> {
  ...
  private final CellAdapter<TreeNode<TextNode>, TextNodeCellView> treeAdapter =
      new CellAdapter<>(
          new CellViewFactory<>() {
            @Override
            public <DATA, VIEW extends CellView<DATA>> VIEW createCellView(
                @NonNull ViewGroup parent, int cellType) {
              return (VIEW)
                  new TextNodeCellView(
                      ItemViewBinding.inflate(
                          LayoutInflater.from(parent.getContext()), parent, false));
            }
          });
  private final CellAdapter<LifecycleEvent, LifecycleCellView> cellAdapter =
      new CellAdapter<>(
          new CellViewFactory<>() {
...
class LifecycleEvent {
  ...
  public String toString() {
    String sb = "LifecycleEvent{" + "event=" + event + '}';
    return sb;
  }
}
