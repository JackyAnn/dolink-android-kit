...
public class Reflects {
  ...
  public static Invocation findInvocation(
      Class<?> invokerClass, Class<?>[] parameterTypes, Class<?> returnClass) {
    return CACHE.computeIfAbsent(
        new Key(invokerClass, parameterTypes, returnClass),
        key -> {
          ...
          for (Method declaredMethod : declaredMethods) {
            ...
            if (Objects.equals(methodReturnType, returnClass)
                && Arrays.equals(methodParameterTypes, parameterTypes)) {
