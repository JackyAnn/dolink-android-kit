...
public class Key {
    ...
    public boolean equals(Object o) {
        ...
        Key key = (Key) o;
        return invokerClass.equals(key.invokerClass) && Arrays.equals(parameterTypes, key.parameterTypes) && returnType.equals(key.returnType);
    }
    ...
    public String toString() {
        ...
        sb.append("invokerClass=").append(invokerClass);
